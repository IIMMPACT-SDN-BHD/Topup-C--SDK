...
namespace iimmpact.Model
{
    ...
    public partial class TopupRequest :  IEquatable<TopupRequest>, IValidatableObject
    {
        ...
        public TopupRequest(string refid = default(string), string product = default(string), string remarks = default(string), string account = default(string), decimal? amount = default(decimal?), bool? sync = default(bool?))
        {
